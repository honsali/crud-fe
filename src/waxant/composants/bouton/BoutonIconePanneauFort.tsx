...
const StyledBouton = styled(Button)`
    ...
    border: 2px solid ${(props) => props.theme.token.colorWarning};
    border-radius: 4px;
    &:hover {
        color: #fff !important;
        background-color: ${(props) => props.theme.token.colorWarning} !important;
        border: 2px solid ${(props) => props.theme.token.colorWarning}!important;
    }
`;

const BoutonIconePanneauFort: React.FC<BoutonProps> = (props) => {
...
export default BoutonIconePanneauFort;
