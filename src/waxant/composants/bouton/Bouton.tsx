...
const StyledBouton = styled(Button) <{ $couleurActive?: string, $couleurHover?: string, $couleurBorder?: string, $inactif?: string }>`
    ${({ $couleurActive, $couleurHover, $couleurBorder, $inactif }) => {
        if ($inactif) {
            return `
                font-weight: 500;
            ...
            return `
                ...
                &:hover{
                    ...
                    border: 2px solid ${$couleurBorder} !important;
                }
...
const Bouton: React.FC<BoutonProps> = (props) => {
    ...
    const mapCouleurActive = { 'fort': colorPrimary, 'danger': colorError, 'normal': '#ffffff' };
    const mapCouleurHover = { 'fort': '#ffffff', 'danger': '#ffffff', 'normal': '#999999' };
    const mapCouleurBorder = { 'fort': colorPrimary, 'danger': colorError, 'normal': '#999999' };
    ...
    return (
        <Tooltip placement="top" title={toolTip || inactif}>
            <StyledBouton //
                ...
                $couleurBorder={mapCouleurBorder[couleur]}
                $inactif={inactif}
            >
