...
export const I18nDepartement = {
    ...
    [enteteConfirmation(ActionDepartement.UcConsulterDepartement.SUPPRIMER_DEPARTEMENT)]: 'Êtes-vous sûr de vouloir Supprimer ce Departement ?',
    ...
    [enteteConfirmation(ActionDepartement.UcCreerDepartement.CREER_DEPARTEMENT)]: 'Êtes-vous sûr de vouloir créer ce Departement ?',
    ...
    [enteteConfirmation(ActionDepartement.UcModifierDepartement.MAJ_DEPARTEMENT)]: 'Êtes-vous sûr de vouloir Maj ce Departement ?',
